...
function element(overrides: Partial<GardenOut['obstacles'][number]> = {}) {
  return {
    ...
    height: null, label: null, roof: 'unknown', eaves_m: null, height_source: 'user',
...
describe('GardenCanvas — editing an outline', () => {
  ...
  it('gives a bed the same handles, though the API lists it separately', () => {
    ...
    const bed = {
      ...
      sky_view: null, relative_light: null, expected_sun_h: null, light_computed_at: null, height_above_ground: 0, label: null,
      plantings: [],
