"""Garden plans, addressed by share token — the garden as a whole.

The elements drawn inside it (beds, obstacles) are routed from `elements.py`;
the helpers both need — `require_garden`, `require_bed`, `to_out` — live here.
