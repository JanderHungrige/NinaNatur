...
the rectangle's, and every line is cut to the outline. On a rectangle neither
changes anything. The roof's light is still the model's, over its rectangle;
...
def roof_lines(
    ...
    two corners at that end; a pent roof's upper edge, which the model keeps as
    its ridge. Nothing for a roof it treats as a plane — flat, unidentified,
...
__all__ = ["MIN_PIECE_M", "inside_parts", "roof_lines"]
