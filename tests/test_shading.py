...
NORTH_WALL = Obstacle(x=0.0, y=5.0, radius=3.0, height=4.0)
...
def test_a_point_north_of_an_obstacle_is_shaded_by_a_southern_sun() -> None:
    ...
    south_wall = Obstacle(x=0.0, y=-5.0, radius=3.0, height=4.0)
...
def test_a_taller_obstacle_shades_further() -> None:
    ...
    short = Obstacle(x=0.0, y=-6.0, radius=3.0, height=4.0)
    tall = Obstacle(x=0.0, y=-6.0, radius=3.0, height=10.0)
